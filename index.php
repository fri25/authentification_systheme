...
<head>
    ...
    <title>Bienvenue sur votre site</title> <!-- Corrigé la casse pour une convention plus standard -->
...
<body>
    ...
    <section class="bg-center bg-no-repeat bg-gray-700 bg-blend-multiply">
        <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
            ...
            <p class="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">Connectez-vous pour en découvrir davantage.</p> <!-- Corrigé "découvrire" en "découvrir" -->
            <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                <a href="login.php" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                    Connexion <!-- Corrigé "CONNECTION" en "Connexion" pour le français -->
